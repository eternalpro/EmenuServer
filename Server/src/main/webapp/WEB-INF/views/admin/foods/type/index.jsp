...
<layout:adminLayout title="菜类维护" menu="foodstype" faIcon="fa-list" modal="true" paged="false">
    ...
    <jsp:attribute name="main">
        <div class="row">
            <div class="col-md-12">
                <div class="well">
                    <a class="btn btn-primary" href="${ctx}/admin/foods/type/form" data-toggle="modal"
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    <th>
                                        序号
                                        <a href="#" data-toggle="sort" data-sort="${sort}" data-url="${ctx}/admin/foods/type">
                                ...
                                <c:forEach items="${records}" var="record" varStatus="i">
                                    <tr>
                                        ...
                                        <td>${record.title}</td>
                                        <td>
                                            <a href="${ctx}/admin/foods/type/form/${record.id}" class="btn btn-primary btn-sm"
                                               data-toggle="modal" data-target="#adminModalLg">编辑</a>
                                            <a href="${ctx}/admin/foods/type/delete/${record.id}" class="btn btn-danger btn-sm"
